/* #121 · #125 · #129 — 실제 브라우저 증빙 (헤드리스 Chrome · CDP · 실제 DOM 클릭 · 페이지의 실제 setTimeout)
   사용: node demo/test/milestone/v0.4.7/issues/121/v047_cdp.js [--out <dir>] [--chrome <chrome.exe>] [--read-only] [--no-shots] [--tutorial] [--ref <sha>]
...
(async()=>{
  ...
  const report={source:path.relative(ROOT,HTML).replace(/\\/g,"/"),blobSha1:HASH,ref:REF||null,refBlobSha1:refHash,servedFrom,
    at:new Date().toISOString(),tool:"demo/test/milestone/v0.4.7/issues/121/v047_cdp.js",checks:[]};
