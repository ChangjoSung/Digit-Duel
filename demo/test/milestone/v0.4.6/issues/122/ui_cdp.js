/* #122 · #124 · #126 — 세로 UI · 승패 연출 브라우저 증빙 (헤드리스 Chrome · CDP · 실제 클릭 · 페이지의 실제 타이머)
   사용: node demo/test/milestone/v0.4.6/issues/122/ui_cdp.js [--out <dir>] [--chrome <chrome.exe>] [--read-only] [--no-shots]
...
(async()=>{
  ...
  const report={source:"demo/index.html",blobSha1:HASH,at:new Date().toISOString(),
    tool:"demo/test/milestone/v0.4.6/issues/122/ui_cdp.js",checks:[]};
