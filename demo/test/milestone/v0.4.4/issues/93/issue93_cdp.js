/* #93 온라인 양측 자기 진영 아래 표시 — 실제 브라우저 증빙 (헤드리스 Chrome · CDP · 실제 릴레이 서버 · 온라인 클라이언트 2개 · 실제 마우스 클릭)
   사용: node demo/test/milestone/v0.4.4/issues/93/issue93_cdp.js [--out <dir>] [--chrome <chrome.exe>] [--read-only]
...
const OUT=path.resolve(opt("--out",path.join(ROOT,"docs","milestone","v0.4.4","issues","93","Mars","artifacts")));
