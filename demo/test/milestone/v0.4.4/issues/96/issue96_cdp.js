/* #96 감전 부여 확률 하향 — 실제 브라우저(헤드리스 Chrome · CDP) 좁은 실측 + 스크린샷 (file:// · desktop-1280 만)
   사용: node demo/test/milestone/v0.4.4/issues/96/issue96_cdp.js [--html <index.html>] [--out <dir>] [--chrome <chrome.exe>] [--no-shots] [--read-only]
...
const OUT=path.resolve(opt("--out",path.join(ROOT,"docs","milestone","v0.4.4","issues","96","Mars","artifacts")));
