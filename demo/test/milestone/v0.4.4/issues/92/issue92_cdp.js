/* #92 속성 교차 공격기 교체 — 실제 브라우저 증빙 (헤드리스 Chrome · CDP · 실제 마우스 클릭 · 실제 릴레이 서버 · 온라인 클라이언트 2개)
   사용: node demo/test/milestone/v0.4.4/issues/92/issue92_cdp.js [--out <dir>] [--chrome <chrome.exe>] [--read-only] [--no-shots]
...
const OUT=path.resolve(opt("--out",path.join(ROOT,"docs","milestone","v0.4.4","issues","92","Mars","artifacts")));
