/* #95 공격형 연속 공격 위력 완화 — 시드 고정 1:1 단독 전투 before/after 비교
   사용: node demo/test/milestone/v0.4.4/issues/95/attack_balance_compare.js [--n 150] [--seed 5000] [--html <index.html>] [--out <json>] [--no-symmetry]
...
L.push(`- 재현: \`node demo/test/milestone/v0.4.4/issues/95/attack_balance_compare.js --n ${N} --seed ${SEED}\` · 소요 ${out.elapsedMs}ms · 생성 ${out.generated}`);
