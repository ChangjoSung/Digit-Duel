/* #106 턴 흐름·연출 — 실제 브라우저 증빙 (헤드리스 Chrome · CDP · 실제 릴레이 서버 · 온라인 클라이언트 2개 + PVE 탭 · 실제 마우스 클릭 · 실제 타이머)
   사용: node demo/test/milestone/v0.4.4/issues/106/issue106_cdp.js [--out <dir>] [--chrome <chrome.exe>] [--read-only] [--no-shots]
...
const OUT=path.resolve(opt("--out",path.join(ROOT,"docs","milestone","v0.4.4","issues","106","Mars","artifacts")));
