/* #104 온라인 양측 말·위치 불일치 — 자연 흐름 2클라이언트 락스텝 회귀 (헤드리스)
   사용: node demo/test/smoke_online_sync.js [demo/index.html] [--seeds N] [--steps M] [--verbose]
        git show <sha>:demo/index.html | node demo/test/smoke_online_sync.js --stdin   (음성 대조 — 파일 작성 0)
