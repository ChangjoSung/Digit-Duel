/* #93/#104 온라인 보드 방향(orientation) 독립 감사 — 헤드리스 2클라이언트 (Mars_3, 2026-09-08)
   사용: node demo/test/regression/smoke_orientation_audit.js                 # 기본: git show 6baa0b5:demo/index.html 을 메모리로 로드 (작업 트리 무관·파일 쓰기 0)
        node demo/test/regression/smoke_orientation_audit.js --ref <sha>     # 다른 고정 ref
        node demo/test/regression/smoke_orientation_audit.js --path demo/index.html   # 작업 트리 파일
        git show <sha>:demo/index.html | node demo/test/regression/smoke_orientation_audit.js --stdin
