/* Issue114 v0.4.5 rules + two isolated lockstep clients. Read-only; node demo/test/smoke_issue114.js [demo/index.html] */
"use strict";
const assert=require("assert/strict"), H=require("./harness"), path=require("path");
