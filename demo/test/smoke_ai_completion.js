/* #132 AI vs AI 완주 게이트 (CI 필수) — node demo/test/smoke_ai_completion.js [demo/index.html]
   목적: CLAUDE.md 의 "AI vs AI 완주 확인" 을 리포트가 아니라 판정으로 만든다.
   demo/test/ai_compare.js 는 표를 stdout 에 찍고 끝나 process.exit 도 어서션도 없다 (항상 0) — 게이트가 될 수 없다.
