...
- 2026-09-09 CJ 일정 변경: **v0.4.6(Milestone12)=Roblox 포팅 #118**, **v0.4.7(Milestone13)=기존 CJ 게임 #119–#131·Infra #132/#134**. 완료 PR133도 #132와 함께 v0.4.7에 보관한다. CJ가 #121·#125·#129의 분석을 승인하고 구현을 지시했으며, 나머지 게임 이슈는 번호별 구현 요청을 기다린다. 해당 승인 규칙·검수 기준은 [v0.4.7 게임플레이 계약](docs/milestone/v0.4.7/issues/121/Venus/gameplay-spec.md)과 GDD-18·GDD-13 DL42를 따른다. Roblox 담당 lee775의 별도 작업·브랜치는 해당 작업자 소유로 보존한다. 현재 정식 출시는 v0.4.5이고 Unity v0.5.0은 별도 계획이다.
