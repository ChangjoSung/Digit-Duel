...
- 2026-09-10 현재 일정: **v0.4.6(Milestone12)=Roblox 포팅 #118**, **v0.4.7(Milestone13)=기존 CJ 게임 #119–#131·추가 #146·Infra #132/#134**. #121·#125·#129는 PR143 통합 후 CJ QA PASS로 종결했다. 후속 CJ 승인으로 **#146·#131·#128·#130 구현 진행**: 도망 기본30%/버프70%·추가 반격 삭제, 4슬롯 전부 불가 시 기본 공격 없이 수동 대기(왕·동료 본체 유지), 텔레포트 양단 함정 상태 차단·2단계 안내, 브라우저별 튜토리얼 검증·보호막 합산. 최신 [승인 계약](docs/milestone/v0.4.7/issues/146/Venus/gameplay-spec.md)과 GDD-13 DL45·GDD-18을 따른다. 나머지는 번호별 구현 요청 대기다. Roblox 담당 lee775의 별도 작업·브랜치는 보존한다. 현재 정식 출시는 v0.4.5이고 Unity v0.5.0은 별도 계획이다.
