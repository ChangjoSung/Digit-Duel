#!/usr/bin/env python3
"""tools/art/minion_art.py 회귀 테스트.

실행:  python -m unittest discover -s tools/art/test -v
       python tools/art/test/test_minion_art.py
...
class CliTest(unittest.TestCase):
    def cli(self, *args: str) -> subprocess.CompletedProcess:
        return subprocess.run(
            [sys.executable, str(REPO_ROOT / "tools" / "art" / "minion_art.py"), *args],
