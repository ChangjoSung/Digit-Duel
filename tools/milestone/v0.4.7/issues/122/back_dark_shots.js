/* #122 CJ QA REVISE (2026-09-10) — 좌상단 뒤로가기 · 어두운 배경 실촬영 증빙 (헤드리스 Chrome · CDP · 실제 클릭)
   사용: node tools/milestone/v0.4.7/issues/122/back_dark_shots.js [--out <dir>] [--chrome <chrome.exe>] [--read-only] [--no-shots]

   **좁은 증빙이다.** 같은 이슈의 demo/test/milestone/v0.4.7/issues/122/ui_cdp.js 가 이미 찍어 둔 43장(세로 레이아웃 전반·
