...
최신 정식 릴리스는 **v0.4.4**입니다. **v0.4.5는 턴 행동 추가 내용 분석과 문서·튜토리얼 갱신 단계**이며, 검토안을 출시된 규칙으로 읽지 않습니다.
...
| 현재 v0.4.5 안건 | [Milestone11](https://github.com/ChangjoSung/Digit-Duel/milestone/11), [CJ 턴 행동 원문](https://app.notion.com/p/3d51e7f1708580b0916ded4bd3d9d06e) |
