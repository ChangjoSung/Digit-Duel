...
> 2026-09-09 · Mercury(PD, GPT-6 Astra/high). CJ가 #121·#125·#129의 권고안과 기술 3종 직접 선택을 승인해 구현·검수를 진행한다. 마녀 풀 효과도 실제 HP 피해만큼 즉시 회복으로 확정됐으며 답변 대기는 없다. 정식 출시는 v0.4.5, Roblox #118은 v0.4.6, 이번 게임 작업은 v0.4.7이다. 나머지 게임 이슈는 번호별 착수 지시를 기다린다.
