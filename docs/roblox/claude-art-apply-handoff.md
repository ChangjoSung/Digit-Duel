...
> 2026-09-10 후속: 기본 P0 이후 AI 창·봇 자산8종을 추가 납품했다. [최신 적용 계약](../../roblox/assets/ai-window-README.md) · [납품 보고](../art/roblox-v0.5.0/earth-ai-window-report.md). 아래 HEAD·신규60개·재사용83개는 당시 이력이다. 최신 AI dry-run은151대상/신규8/재사용143이며 창 좌표·봇 피벗·등급 배지 연결은 전용 계약을 우선한다.
