...
**P0-A 하수인 60장 완료 + 후속 P0-B 토큰 9장 완료. 전체 P0 129장 중 69장 납품이며, 전체 완료가 아니다.**
이 문서의 제작·QA·worker_done은 최초 P0-A 납품 이력이다. 현재 토큰 결정과 추가 납품은 [후속 토큰 보고](earth-token-report.md)를 따른다.
...
| P0-B 토큰·속성·흔적 | 14 | 9 | 토큰 완료, 속성4·흔적1 미납품 |
...
- P0-A PNG 60장 합계: **4,384,108 bytes**. [납품 manifest](../../../roblox/assets/manifest.csv)의 기존 하수인 60행과 파일 경로 집합이 정확히 같다. 현재 전체 manifest는 후속 토큰9행을 포함한69행이다.
...
후속 P0-B 토큰5종의 검수는 [토큰 보고](earth-token-report.md)에 별도로 기록했다. 미제작 속성4종 검수, 9-slice 늘림 검수, Studio 실제 표시,
...
worker_done:
  ...
  summary: |
    ...
    당시 P0-B/C/D 69PNG와 P1/P2는 미납품. 후속 토큰9PNG 납품으로 현재 P0 잔여60PNG.
