...
| v0.4.7 | [Milestone 13](https://github.com/ChangjoSung/Digit-Duel/milestone/13) | #121·#125·#129·#146·#131·#130 CJ QA PASS·CLOSED(미출시) · #128 매 페이지 로드 튜토리얼 표시 2026-09-10 CJ QA PASS·CLOSED · **#122·#124·#126 세로 화면·왕/동료 아트·승패 효과 제작 중(OPEN)** · 나머지 게임 이슈 착수 대기 · Infra #132/#134 완료 | 진행 중 | [v0.4.7](v0.4.7/README.md) |
