...
사용자용 안내는 [v0.4.7 릴리스 노트(개발 중·미출시)](../../releases/v0.4.6.md)에 있다. **현재 정식 출시본은 여전히 [v0.4.5](../../releases/v0.4.5.md)이며 플레이 기준 규칙도 v0.4.5다.**
