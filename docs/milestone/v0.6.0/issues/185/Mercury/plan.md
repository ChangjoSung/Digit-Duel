# #185 — 정적 TSV·타입 생성·데이터 검증
2026-09-11 · Mercury(PD) · 계획 등록, 구현 미완료.

- [GitHub Issue](https://github.com/ChangjoSung/Digit-Duel/issues/185)가 범위·AC·현재 상태의 원본이다.
- 선행: #182 / 스키마 분석은 선행 가능.
