...
CJ 디자인 확인으로 아트 납품은 수락됐다. 게임 화면 적용은 [PR #90](https://github.com/ChangjoSung/Digit-Duel/pull/90)에 취합했고 Saturn 독립 QA를 통과했다. [Issue #89](https://github.com/ChangjoSung/Digit-Duel/issues/89)는 CJ 플레이 확인 대기다. 최신 수량과 QA 상태는 [외형 규격 §8.2](../../specs/minion-visual-spec-v0.4.3.md)에 모은다.
...
[전투 패치](battle-patches/)를 Mars의 [출력 도구](../../issues/87/Mars/art-pipeline.md)로 검증·출력한다.
도구의 외접상자 중점은 기하학적 대리 지표이며 시각 중심의 독립 판정을 대체하지 않는다.

- Earth 제작 보고: [불·물 파일럿](../../issues/87/Earth/earth-1-native-report.md), [풀·번개 파일럿](../../issues/87/Earth/earth-2-native-report.md),
  [불·물 잔여 8종](../../issues/87/Earth/earth-1-full-delivery-report.md), [풀·번개 잔여 8종](../../issues/87/Earth/earth-2-full-delivery-report.md).
- 파일럿 검수: [1차](../../issues/87/Saturn/pilot-qa-saturn.md) → [뇌격수 V1 REVISE](../../issues/87/Saturn/pilot-v1-qa-saturn.md) → [V2 ART PASS](../../issues/87/Saturn/pilot-v2-qa-saturn.md).
  뇌격수는 국소 수정으로 해결되지 않아 얼굴·몸 비례를 재구성한 뒤 통과했다.
- 도구: [Mars 구현·출력 증빙](../../issues/87/Mars/mars-pipeline-report.md), [Saturn 독립 기술 PASS](../../issues/87/Saturn/tooling-qa-saturn.md).
  Mars 테스트 68/68과 Saturn의 읽기 전용 검증은 수행 주체와 범위를 구분한다.
- 전체 납품: [Saturn 최종 20종 ART·기술 검수](../../issues/87/Saturn/final-qa-saturn.md). 종별 판정과 검수 대상 해시를 보존한다.
- [원본 QA](../../issues/87/Saturn/source-qa-saturn.md)는 최초 반입 시점의 기록이며 현재 수정본 판정과 구분한다.

초기 이미지 생성 시험 2건은 투명도·크기·색 수 규격을 충족하지 못해 참고 이력으로만 보존한다.
[Earth_1 시험 보고](../../issues/87/Earth/earth-1-report.md)와 [Earth_2 시험 보고](../../issues/87/Earth/earth-2-report.md)의 생성 이미지는 납품 수량에서 제외한다.
...
| 문서 | 역할 |
|---|---|
| [외형 규격](../../specs/minion-visual-spec-v0.4.3.md) | 제작 기준·현재 수량·최종 QA·제품 결정 |
