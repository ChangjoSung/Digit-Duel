...
2026-09-10 · Ref #118. **기본 P0 129/129 + AI 창·봇 + 공통 배너 + FX13·메모2·배너 변형2 납품**.

- **[전투 FX·메모 적용 계약](fx/README.md)**: 96×96×8프레임13종 + 메모2. [납품 보고](../../docs/art/roblox-v0.5.0/earth-fx-report.md).
- **[배너 초록·빨강2종 납품 보고](../../docs/art/roblox-v0.5.0/earth-banner-variants-report.md)**: 공통과 동일한256×128·SliceCenter16,16,112,112, 색조만 변경. 신규17PNG의 업로드·코드 연결은 Mars 후속이다.
...
- [manifest.csv](manifest.csv): 기존136행 + FX13·메모2·배너 변형2 =153행. 기존 헤더/행 보존,18열 유지, 파일·원고 SHA-256와 크기·틴트·SliceCenter 기록. 모델은 넣지 않는다.
...
- 별도 [로비 납품](lobby/README.md): 기존6메시·6알베도·1상태 표지 + 신규봇1메시·1알베도, [로비 manifest](lobby/manifest.csv)15행. 루트153PNG와 분리한다.
- 이번 FX P1/P2·메모 및 배너 변형 요청은 전량 납품했다. P2 스토어·모바일이나 실제 게임 연출 구현까지 완료됐다는 뜻은 아니다.
...
현행 업로더의 세 manifest 집계는169대상(Image161·Model8)이며, 이번 dry-run은 **신규 Image17 · Model0 · 기존152 재사용**이다.
기존 업로드는 Mars의 작업이다. Earth는 이번17PNG를 업로드하거나 rbxassetid를 발급하지 않았다.
