...
### 이번 버전 — v0.4.6 (2026-09-11 출시)

> **2026-09-11 버전 재배번** ([#169](https://github.com/ChangjoSung/Digit-Duel/issues/169) · CJ 승인). 이 버전은 종전 `v0.4.7`이었습니다. 같은 재편에서 **Roblox 포팅은 `v0.5.0`**, **Unity 포팅은 `v0.6.0`**이 됐습니다.
>
> **`roblox/` 소스가 저장소에 함께 들어 있지만 v0.4.6의 출시 기능이 아닙니다.** 필수 CI가 그 폴더에서 돌아 분리할 수 없을 뿐이며, Roblox는 v0.5.0으로 따로 출시합니다. 담당 작업자는 [Roblox 작업자 안내](docs/roblox/BRANCH-POLICY.md)를 따릅니다.
...
| 정식 버전 | [v0.4.6](docs/releases/v0.4.6.md) — 2026-09-11 출시 |
| 최근 업데이트 | 2026-09-08 |
